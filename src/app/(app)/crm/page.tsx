...
export default async function CrmPage({
  ...
  // Listen-Query: für Pipeline IMMER alle laden (Filter ignoriert),
  // für Tabelle nach Status filtern wenn gesetzt
  const list = await db
    .select({
      id: contacts.id,
  ...
  return (
    <div className="p-4 md:p-6 space-y-4">
      ...
      {!isPipeline && <ContactFilter counts={counts} />}

      {isPipeline ? (
        <PipelineView contacts={list} />
      ) : (
