    ...
    <>
      ...
      {open && (
        ...
        >
          ...
          />
          <div className="absolute left-0 top-0 h-full w-72 max-w-[85vw] flex flex-col bg-sidebar text-slate-300 shadow-2xl">
            <button
              onClick={() => setOpen(false)}
              className="absolute right-2 top-3 h-9 w-9 inline-flex items-center justify-center rounded-md text-slate-400 hover:text-white hover:bg-sidebar-soft transition"
